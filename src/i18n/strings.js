export const STR = {
  vi: {
    ...
    cast: {
      ...
      numberTime: "Số + Giờ", numberTimeZh: "數時占", numberTimeDesc: "Một số bất kỳ kết hợp với giờ hiện tại",
      ...
      firstNumber: "Số thứ nhất", secondNumber: "Số thứ hai",
    ...
    result: {
      ...
      methodNames: { time: "Thời gian", number: "Số", sound: "Âm thanh", numberTime: "Số + Giờ", spont: "Cảm ứng" },
    ...
    wuxing: {
      title: "Năng lượng Ngũ hành",
      titleZh: "五行旺衰",
      pillarsBasedOnCast: "Theo bốn cột tại thời điểm dựng quẻ",
      pillarsBasedOnNow: "Theo bốn cột tại thời điểm xem (quẻ này không dùng phép Thời gian)",
      pillars: { year: "Năm", month: "Tháng", day: "Ngày", hour: "Giờ" },
      noDayBranch: "—",
      season: "Mùa",
      tiSelf: "Hành Thể",
      yongSelf: "Hành Dụng",
      states: {
        wang:  { name: "Vượng", zh: "旺", desc: "Đỉnh thịnh — đúng thời, năng lượng cực thịnh." },
        xiang: { name: "Tướng", zh: "相", desc: "Hỗ trợ — được mùa nuôi dưỡng, đang lên." },
        xiu:   { name: "Hưu",   zh: "休", desc: "Nghỉ ngơi — đã làm xong việc, ổn định nhưng không tiến." },
        qiu:   { name: "Tù",    zh: "囚", desc: "Bị kìm hãm — ngược thời, suy yếu." },
        si:    { name: "Tử",    zh: "死", desc: "Tận diệt — bị thời tiết khắc, không sinh khí." },
      },
    },
    auth: {
  ...
  en: {
    ...
    cast: {
      ...
      numberTime: "Number + Hour", numberTimeZh: "數時占", numberTimeDesc: "A single number folded with the current hour branch",
    ...
    result: {
      ...
      methodNames: { time: "Time", number: "Number", sound: "Word/Sound", numberTime: "Number + Hour", spont: "Spontaneous" },
    ...
    wuxing: {
      title: "Five-Element Energy",
      titleZh: "五行旺衰",
      pillarsBasedOnCast: "By the four pillars at cast time",
      pillarsBasedOnNow: "By the four pillars at viewing time (the cast was not time-based)",
      pillars: { year: "Year", month: "Month", day: "Day", hour: "Hour" },
      noDayBranch: "—",
      season: "Season",
      tiSelf: "Ti element",
      yongSelf: "Yong element",
      states: {
        wang:  { name: "Wàng",  zh: "旺", desc: "Flourishing — at its peak, in its season." },
        xiang: { name: "Xiāng", zh: "相", desc: "Supported — generated by the season, ascending." },
        xiu:   { name: "Xiū",   zh: "休", desc: "Resting — its work is done, stable but not advancing." },
        qiu:   { name: "Qiú",   zh: "囚", desc: "Imprisoned — opposes the season, weakened." },
        si:    { name: "Sǐ",    zh: "死", desc: "Dying — overcome by the season, depleted." },
      },
    },
    auth: {
  ...
  zh: {
    ...
    cast: {
      ...
      numberTime: "數時占", numberTimeZh: "數時占", numberTimeDesc: "以一數合時辰起卦",
      spont: "外應占", spontZh: "外應占", spontDesc: "隨機起卦",
      question: "所問之事(可省)", questionPh: "欲問者…",
      firstNumber: "第一數", secondNumber: "第二數",
      text: "字句", textPh: "輸入字句…",
    ...
    result: {
      ...
      methodNames: { time: "時間", number: "數字", sound: "聲音", numberTime: "數時", spont: "外應" },
    ...
    wuxing: {
      title: "五行旺衰",
      titleZh: "五行旺衰",
      pillarsBasedOnCast: "依起卦時之四柱",
      pillarsBasedOnNow: "依當下之四柱(此卦未用時間占)",
      ...
      yongSelf: "用之行",
      states: {
        wang:  { name: "旺", zh: "旺", desc: "當令 — 氣運極盛。" },
        xiang: { name: "相", zh: "相", desc: "得時所生 — 氣勢上揚。" },
        xiu:   { name: "休", zh: "休", desc: "生時功成 — 平穩無進。" },
        qiu:   { name: "囚", zh: "囚", desc: "克時被制 — 氣勢受抑。" },
        si:    { name: "死", zh: "死", desc: "被時所克 — 氣盡無力。" },
      },
    },
    auth: {
      signIn: "登入以同步",
